...
keksbruch is free software, published **free of charge and for non-commercial purposes**.
It is provided **"as is", without warranty of any kind** and **without any guarantee of correctness, security, or fitness for a particular purpose**, to the fullest extent permitted by applicable law.
**Use it at your own risk.**
Under German law, freely provided open-source software is treated as a gift (*Schenkung*); the author's liability is limited to intent and gross negligence (§§ 521 ff. BGB), and this project does not assume liability beyond that statutory minimum.
...
keksbruch is a quality-assurance tool: its purpose is to verify and harden cookie handling.
Please use it lawfully, and only to test software and systems you are entitled to test.
Its generated inputs are meant for hardening — not for any hostile, unauthorised, or unlawful use.
